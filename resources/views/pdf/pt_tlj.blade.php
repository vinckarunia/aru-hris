...
<body>
    ...
    <table>
        <tr>
            <td class="num-col">1.</td>
            <td>
                <strong>PIHAK PERTAMA</strong> menempatkan <strong>PIHAK KEDUA</strong> di <strong>{{ strtoupper($contract->assignment->project->client->full_name ?? 'PT. CJ Foodville Bakery And Cafe Indonesia') }}</strong> dengan status <strong>Pekerja Part time (Pekerja Paruh Waktu)</strong> dengan ketentuan sebagai berikut:
    ...
    <table>
        <tr>
            <td class="num-col">1.</td>
            <td><strong>PIHAK KEDUA</strong> telah menyetujui jam kerja yang dibuat oleh pihak pertama dengan jadwal kerja harian yaitu sehari 4 jam dalam sehari dengan sistem kerja shifting (1 shift atau 2 shift) dalam sehari disesuaikan dengan jadwal jam kerja dari <strong>PIHAK PERTAMA</strong>.</td>
        </tr>
        <tr>
            <td class="num-col">2.</td>
    ...
    <table>
        ...
        <tr>
            <td class="num-col">2.</td>
            <td>Apabila <strong>PIHAK KEDUA</strong> tidak masuk bekerja dengan alasan apapun maka upah/ gajinya tidak diperhitungkan sebesar (Upah Pokoknya/perhitungan gaji pokok : 21 hari x hari kerja tidak masuk bekerja) + tunjangan lain selama hari tidak masuk kerja.</td>
        </tr>
        <tr>
            <td class="num-col">3.</td>
