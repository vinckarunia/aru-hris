...
interface DataRequestIndexProps extends PageProps {
    ...
    filters?: { sort: string; direction: string; status?: string; type?: string };
}

export default function DataRequestIndex({ dataRequests, filters }: DataRequestIndexProps) {
    ...
    const reviewableIds = dataRequests.filter(isReviewable).map(r => r.id);
        ...
        <Layout title="Data Request" header="Data Request">
            <div className="mb-6">
                <div className="flex justify-between items-center mb-4">
                    <h1 className="text-2xl font-bold text-slate-800 dark:text-white">Manajemen Pengajuan Perubahan</h1>
