...
export default function DataRequestIndex({ dataRequests, filters, filterOptions }: DataRequestIndexProps) {
    ...
    const fieldLabels: Record<string, string> = {
        ...
        ktp_expiry: 'Masa Berlaku KTP',
        phone_domicile: 'No. Handphone Domisili',
        size_shoe: 'Ukuran Sepatu',
        size_uniform: 'Ukuran Seragam',
        reference_name: 'Nama Referensi',
        reference_relationship: 'Hubungan Referensi',
        reference_phone: 'No. HP Referensi',
        ...
        school_name_city: 'Nama Sekolah & Kota',
    ...
    const enumLabels: Record<string, Record<string, string>> = {
        contract_type: { 'Kontrak': 'Kontrak', 'Harian': 'Harian', 'Part-time': 'Part-time', 'Mitra': 'Mitra' },
