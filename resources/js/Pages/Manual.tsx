        ...
        },
        {
            ...
            content: (
                <div className="space-y-4 text-slate-600 dark:text-slate-300">
                    ...
                    <p>Setelah ada penempatan, Anda bisa membuat kontrak kerja (PKWT, Harian, Part-time, Mitra).</p>
                    <ul className="list-disc pl-5 space-y-2">
                        ...
                        <li><strong>Dokumen Legal:</strong> Anda dapat mencetak/mendownload langsung dokumen kontrak seperti PKWT, PKPH (Harian & Part-time), kontrak Mitra, atau Surat Tugas dari detail kontrak. Selain itu, dokumen <strong>Paklaring (Surat Keterangan Kerja)</strong> dapat diunduh di tab Penempatan, dengan syarat: (1) Status penempatan telah menjadi <em>Resign</em>, <em>Contract Expired</em>, atau <em>Project Closed</em>, dan (2) Status pengembalian perangkat kerja (di form Edit Penempatan) telah diubah menjadi <strong>Sudah</strong>.</li>
                    </ul>
            ...
            content: (
                <div className="space-y-4 text-slate-600 dark:text-slate-300">
                    ...
                    <ul className="list-disc pl-5 space-y-2">
                        ...
                        <li><strong>Penomoran Dokumen:</strong> Sistem cerdas membedakan penomoran surat (contoh: <code>PKWT</code> untuk kontrak regular, <code>PKPH</code> untuk part-time/harian, dan <code>MITRA</code> untuk kontrak Mitra) secara otomatis tanpa perlu hardcode pada template.</li>
                    </ul>
                </div>
            )
        }
