            ...
            content: (
                <div className="space-y-4 text-slate-600 dark:text-slate-300">
                    ...
                    <ul className="list-disc pl-5 space-y-2">
                        ...
                        <li><strong>Dokumen Legal:</strong> Anda dapat mencetak/mendownload langsung dokumen kontrak seperti PKWT, PKPH (Harian & Part-time), atau Surat Tugas dari detail kontrak. Selain itu, dokumen <strong>Paklaring (Surat Keterangan Kerja)</strong> dapat diunduh di tab Penempatan, dengan syarat: (1) Status penempatan telah menjadi <em>Resign</em>, <em>Contract Expired</em>, atau <em>Project Closed</em>, dan (2) Status pengembalian perangkat kerja (di form Edit Penempatan) telah diubah menjadi <strong>Sudah</strong>.</li>
                    </ul>
