                    ...
                    <nav className="flex-1 overflow-y-auto py-6 space-y-8 px-4 overflow-x-hidden [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                        ...
                        <div>
                            ...
                            <div className={`space-y-1 overflow-hidden transition-all duration-300 ${collapsedMenus['masterData'] ? 'max-h-0 opacity-0' : 'max-h-[500px] opacity-100'}`}>
                                ...
                                {(user.role === 'SUPER_ADMIN' || user.role === 'ADMIN_ARU') && (
                                    <Link href={route('internal-employees.index')} className={`flex items-center gap-3 py-3 rounded-xl text-slate-600 dark:text-slate-400 hover:bg-slate-100 hover:shadow-sm hover:text-primary dark:hover:bg-slate-800 transition-all group ${isSidebarCollapsed ? 'lg:justify-center px-0' : 'px-4'}`} title="Karyawan Internal">
                                        <iconify-icon icon="solar:shield-user-linear" width="20" className="shrink-0 group-hover:text-primary transition-colors"></iconify-icon>
                                        <span className={`font-medium whitespace-nowrap transition-all duration-300 ${isSidebarCollapsed ? 'lg:w-0 lg:opacity-0 lg:hidden' : 'w-auto opacity-100 block'}`}>Karyawan Internal</span>
                                    </Link>
                                )}
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className={`space-y-1 overflow-hidden transition-all duration-300 ${collapsedMenus['operational'] ? 'max-h-0 opacity-0' : 'max-h-[500px] opacity-100'}`}>
                                {(user.role === 'SUPER_ADMIN' || user.role === 'ADMIN_ARU' || user.role === 'PIC') && (
                                ...
                                <Link href={route('data-requests.index')} className={`flex items-center gap-3 py-3 rounded-xl text-slate-600 dark:text-slate-400 hover:bg-slate-100 hover:shadow-sm hover:text-primary dark:hover:bg-slate-800 transition-all group ${isSidebarCollapsed ? 'lg:justify-center px-0' : 'px-4'}`} title="Data Requests">
                                    ...
                                    <span className={`font-medium whitespace-nowrap transition-all duration-300 ${isSidebarCollapsed ? 'lg:w-0 lg:opacity-0 lg:hidden' : 'w-auto opacity-100 block'}`}>Data Request</span>
                                </Link>
                                {(user.role === 'SUPER_ADMIN' || user.role === 'ADMIN_ARU') && (
                        ...
                        {(user.role === 'SUPER_ADMIN' || user.role === 'ADMIN_ARU') && (
                            <div>
                                ...
                                <div className={`space-y-1 overflow-hidden transition-all duration-300 ${collapsedMenus['adminSetup'] ? 'max-h-0 opacity-0' : 'max-h-[500px] opacity-100'}`}>
                                    ...
                                    <Link href={route('audit-logs.index')} className={`flex items-center gap-3 py-3 rounded-xl text-slate-600 dark:text-slate-400 hover:bg-slate-100 hover:shadow-sm hover:text-primary dark:hover:bg-slate-800 transition-all group ${isSidebarCollapsed ? 'lg:justify-center px-0' : 'px-4'}`} title="Audit Log">
                                        <iconify-icon icon="solar:list-check-linear" width="20" className="shrink-0 group-hover:text-primary transition-colors"></iconify-icon>
                                        <span className={`font-medium whitespace-nowrap transition-all duration-300 ${isSidebarCollapsed ? 'lg:w-0 lg:opacity-0 lg:hidden' : 'w-auto opacity-100 block'}`}>Audit Log</span>
                                    </Link>
                                </div>
                            </div>
                        )}
                        ...
                        <div className="flex items-center gap-8">
                            ...
                            <nav className="hidden md:flex items-center gap-1 border-l border-slate-200 dark:border-slate-700/50 pl-8 h-10">
                                ...
                                <Link
                                    ...
                                    className={`px-4 py-2 rounded-lg font-medium transition-all flex items-center gap-2 ${route().current('data-requests.index') ? 'bg-primary/10 text-primary dark:bg-primary/20' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-white'}`}
                                >
